pipeline {
    ...
    environment {
        EMAIL_TO = 'nelsonbonekeh925@gmail.com'
    }
    stages {
        ...
        stage ('5. Email Notification') {
            steps {
               mail bcc: 'nelsonbonekeh925@gmail.com', body: '''Terraform deployment is completed.
               Let me know if the changes look okay.
               Thanks,
               Dominion System Technologies,
              +1 (346) 252-9545''', cc: 'nelsonbonekeh925@gmail.com', from: '', replyTo: '', subject: 'Terraform Infra deployment completed!!!', to: 'nelsonbonekeh925@gmail.com'
